...
var _config = require('./config');var _config2 = _interopRequireDefault(_config);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}var


KDNiaoService = function () {
  function KDNiaoService(options) {_classCallCheck(this, KDNiaoService);
    this.options = Object.create(null);
    this.mixinOptions(_config2.default, options);
    ...
    //4.1	物流轨迹（即时查询）同步查询
      ...
      this.mixinOptions(_config2.default.traceSync, options);
    ...
    //order: {shipper: 'xxx', code: 'xx'}
      ...
      this.mixinOptions(_config2.default.trace, options);
      var requestData = { ShipperCode: order.shipper, LogisticCode: order.code };
    ...
    //5	异步推送（回调）接口
      ...
      this.mixinOptions(_config2.default.asyncSubscribe, options);
